...
describe("Testing the Logger class", () => {
	 ...
	 */
	/*it("should be able to log simple messages with ConsoleTransport", () => {
		...
		expect(consoleLog).toHaveBeenCalledWith(
			"[1970-01-01T00:00:00.000Z] [keylog@pop-os] \x1b[94minfo\x1b[0m: Hi from keylog !"
		);
	});*/
});
